...
function NavBar() {
  ...
  return (
    <AppBar
      position="static"
      sx={{ backgroundColor: "#1A367C", px: "80px", py: "2px" }}
    >
              ...
              <Tooltip title="Menu de Navegação">
                ...
                >
                  <IconButton sx={{ p: 0 }}>
                    <Avatar
                      alt={
                        JSON.parse(localStorage.getItem("auth")).nome ||
                        "Usuário"
                      }
                  ...
                  <Box display={"flex"} alignItems={"center"}>
                    <Typography variant="body2" sx={{ color: "#EDF1FF" }}>
                      {JSON.parse(localStorage.getItem("auth")).nome ||
                        "Usuário"}
                    </Typography>
